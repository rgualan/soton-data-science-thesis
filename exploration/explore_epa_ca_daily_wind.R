...
## Read data
# d <- read.csv("data/epa/epa_daily/2016/daily_WIND_2016.csv", header=T)
# #View(d)
...
# head(d)
# saveRDS(d, "data/epa/epa_daily/2016/daily_WIND_2016_ca.RDS")
d <- readRDS("data/epa/epa_daily/2016/daily_WIND_2016_ca.RDS")
...
if(printPlots) jpeg("img/eda/ca_wind.jpeg", 6, 6, "in", bg="white", res=150)
ggplot(mapCA) +
...
names(d)[3] <- "Wind.speed"
saveRDS(d, "data/epa/epa_daily/2016/california_wind.RDS")
saveRDS(sitesDs, "data/epa/epa_daily/2016/california_wind_sites.RDS")
