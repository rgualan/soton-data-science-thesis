## REF: http://s3l.stanford.edu/blog/?cat=4
#require(imputation)
source("preprocessing/imputation.R")
...
set.seed(100)
imputation.benchmark.random(imputation.fn = getSVDImpute, numRow = 1000, numCol = 10)

set.seed(100)
imputation.benchmark.random(imputation.fn = getRobustSVDImpute, numRow = 1000, numCol = 10)

set.seed(100)
imputation.benchmark.random(imputation.fn = getSVTImpute, numRow = 1000, numCol = 10)

set.seed(100)
imputation.benchmark.random(imputation.fn = getKNNImpute, numRow = 1000, numCol = 10)

set.seed(100)
imputation.benchmark.random(imputation.fn = getgbmImpute, numRow = 1000, numCol = 10)
